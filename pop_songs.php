...
<head>
	<title>Radio Ava | Pop Songs</title>
    ...
    <link href='https://fonts.googleapis.com/css?family=Raleway:500,400,300,200,100' rel='stylesheet' type='text/css'>zzzz
	<style>
...
<body>
    ...
    <div class="MainPlayerStyle">
        <div class="player">
            <img class="player__album-cover" src="songs/pop/joshua-fuller-ta7rN3NcWyM-unsplash.jpg" alt="Placebo's Sleeping With Ghosts album cover">


            <h3>Dev Raez 3D</h3>
            <h3>Satyameva Jayate</h3>
            <div class="player__times">
                <audio class='embed-responsive-item' controls='' preload='none'> <source src='songs/pop/AUD-20180808-WA0001.mp3' type='audio/mp3'></audio><br>
            </div>
            <div class="wrapper">
				...
				while($row = mysqli_fetch_array($result)){
                    ...
                    echo "
							<div class='col-md-6 col-lg-4' >
								<form method='post' action='pop_songs.php'>
									<div class='card-deck'>
										<div class='card-img'>
											<img src='songs/pop_songs/img/$song_image' style='width:90%;height:300px; alt=''>
										</div>
										<div class='card-desc col-12' style='text-align: center'>
											<h3> $song_name | $singer_name</h3>
											<h3>movie - $movie_name</h3>
											<audio class='' controls='' preload='none'> <source src='songs/pop_songs/$audio_file' type='audio/mp3'></audio><br>
