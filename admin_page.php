<?php
    ...
    if(isset($_POST['upload_hindi'])){
		...
		if(isset($_FILES['audio_file'])){
			...
			move_uploaded_file($file_tmp,"songs/pop_songs/".$file_name);
         }
         ...
         if(isset($_FILES['song_image'])){
			...
			move_uploaded_file($file_tmp,"songs/pop_songs/img/".$file_name);
		 }
    ...
    if(isset($_POST['upload_english'])){
		...
		if(isset($_FILES['audio_file'])){
			...
			move_uploaded_file($file_tmp,"songs/rap_songs/".$file_name);
         }
         ...
         if(isset($_FILES['song_image'])){
			...
			move_uploaded_file($file_tmp,"songs/rap_songs/img/".$file_name);
		 }
...
<body>
   ...
   <br> <div class="alert alert-primary" role="alert">
     <center><b>امکان اعمال تغییرات در وب سایت از طریق این صفحه تنها برای ادمین امکان پذیر است!</b></center>
    </div>
    <?php 
        ...
        echo "
            <div class='card'>
                <h3 class='card-header text-center text-uppercase py-4'>لیست کاربران</h3>
                <div class='card-body'>
                    <div id='table' class='table-editable'>
                        <table class='table table-bordered table-responsive-md table-striped text-center'>
                            <tr>
                                ...
                                <th class='text-center'>رمز</th>
                                <th class='text-center'>مشارکت ها</th>
...
<div class="alert alert-primary" role="alert">
     <center><b>موزیک پاپ</b></center>
</div>


<form class="container" method="post" action="admin_page.php" enctype="multipart/form-data">
	<div class="form-row">
		<div class="col">
		...
		<div class="col">
			<div class="md-form mb-4">
				...
				<label data-error="wrong" data-success="right" for="form5">نام موزیک</label>
			</div>
		</div>
		...
		<div class="col " dir="rtl">
			<div class="md-form mb-4">
				...
				<label  data-error="wrong" data-success="right" for="form6">فرمت موزیک</label>
			</div>
		</div>
    </div>
	...
	<div class="form-row ">
        ...
        <div class="col">
			<div class="md-form mb-4">
				...
				<label data-error="wrong" data-success="right" for="form7">نام خواننده</label>
			</div>
		</div>
		...
		<div class="col">
			<div class="md-form mb-4">
				...
				<label data-error="wrong" data-success="right" for="form8">نام فیلم</label>
			</div>
		</div>
		
		<div class="col">
			<div class="text-center">
				<button type="submit" name="upload_hindi" class="btn btn-default btn-rounded mb-4">  بارگذاری <i class="fa fa-upload"></i></button>
			</div>
		</div>
	</div>	
</form>
...
<?php 
    ...
    echo "
        <div class='card'>
            <h3 class='card-header text-center font-weight-bold text-uppercase py-4'>موزیک پاپ</h3>
            <div class='card-body'>
                <div id='table' class='table-editable'>
                    <table class='table table-bordered table-responsive-md table-striped text-center'>
                        <tr>
                            <th class='text-center'>آیدی موزیک</th>
                            <th class='text-center'>نام موزیک</th>
                            <th class='text-center'>فرمت موزیک</th>
                            <th class='text-center'>نام خواننده</th>
                            <th class='text-center'>نام فیلم</th>
                        </tr>
        ";
        while($row = mysqli_fetch_array($result)){
            $song_id = $row['song_id'];
            echo "
                <form method='post' action=admin_page.php>
                    <tr>
                        ...
                        <td>
                            <span><button type='submit' name='$song_id' class='btn btn-danger btn-rounded btn-sm my-0'>پاک کردن موزیک  <i class='fa fa-trash'></i></button></span>
                        </td>
                    </tr>  
                </form>    
            ";
	...
	<div class="form-row">
		...
		<div class="col">
			<div class="md-form mb-4">
				...
				<label data-error="wrong" data-success="right" for="form9">نام موزیک</label>
			</div>
		</div>
		...
		<div class="col">
			<div class="md-form mb-4">
				...
				<label data-error="wrong" data-success="right" for="form10">فرمت موزیک</label>
			</div>
		</div>
    </div>
	...
	<div class="form-row">
        ...
        <div class="col">
			<div class="md-form mb-4">
				...
				<label data-error="wrong" data-success="right" for="form11">نام خواننده</label>
			</div>
		</div>
		...
		<div class="col">
			<div class="md-form mb-4">
				...
				<label data-error="wrong" data-success="right" for="form12">نام فیلم</label>
			</div>
		</div>
		
		<div class="col">
			<div class="text-center">
				<button type="submit" name="upload_english" class="btn btn-default btn-rounded mb-4">بارگذاری <i class="fa fa-upload"></i></button>
			</div>
		</div>
	</div>	
</form>
...
<?php 
    ...
    echo "
        <div class='card'>
            <h3 class='card-header text-center font-weight-bold text-uppercase py-4'>موزیک رپ</h3>
            <div class='card-body'>
                <div id='table' class='table-editable'>
                    <table class='table table-bordered table-responsive-md table-striped text-center'>
                        <tr>
...
<br><div class="alert alert-primary" role="alert">
         <center><b>موزیک های بارگذاری شده</b></center>
    </div>
...
<?php 
    ...
    echo "
        <div class='card'>
            <h3 class='card-header text-center font-weight-bold text-uppercase py-4'>موزیک های آپلود شده</h3>
            <div class='card-body'>
                <div id='table' class='table-editable'>
                    <table class='table table-bordered table-responsive-md table-striped text-center'>
                        <tr>
                            ...
                            <th class='text-center'>فرمت موزیک</th>
                            <th class='text-center'>نام خواننده</th>
                            <th class='text-center'>فایل صوتی</th>
                        </tr>
        ";
        while($row = mysqli_fetch_array($result)){
            $song_id = $row['song_id'];
